...
<body>
    <h2>掲示板</h2>
    <p><a href="logout.php" class="logout">ろぐあうと</a></p>
    <!-- メッセージを表示するコンテナ -->
    <div id="message-container">
        ...
        foreach ($messages as $message) {
            ...
            // メッセージの表示部分
            echo "<div class='message'><strong>$username:</strong><p>$messageText</p>
    <p class='timestamp'>$timestamp</p>";
            echo "<div class='button'>
    <p class='likes evaluation'>
    <button onclick='rateMessage($messageID, 1)'>高評価</button> $likes</p>";
            echo "<p class='dislikes evaluation'>
    <button onclick='rateMessage($messageID, -1)'>低評価</button> $dislikes</p></div>";
